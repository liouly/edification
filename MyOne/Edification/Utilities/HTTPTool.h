...
// 获取首页内容接口地址
#define URL_GET_HOME_CONTENT @"http://api.apiopen.top/recommendPoetry"
// 获取文章接口地址
#define URL_GET_READING_CONTENT @"http://v.juhe.cn/toutiao/index?type=top&key=7322e0eca0302c7872b7c6b9976387ce"
// 获取问题接口地址
#define URL_GET_QUESTION_CONTENT @"http://cn.bing.com/HPImageArchive.aspx?format=js&idx=0&n=1"
